...
\f0\fs22 \cf6 const\cf7  \cf6 int\cf7  maxn=\cf8 100\cf7 ;
\f1\fs24 \cf0 \

\f0\fs22 \cf6 const\cf7  \cf6 int\cf7  INF=\cf8 0x3f3f3f3f\cf7 ;
\f1\fs24 \cf0 \

\f0\fs22 \cf6 int\cf7  mmap[maxn][maxn],dis[maxn];
\f1\fs24 \cf0 \
...
\f0\fs22 \cf7     \cf6 for\cf7 (\cf6 int\cf7  i=\cf8 0\cf7 ;i<n;i++)\{
\f1\fs24 \cf0 \

\f0\fs22 \cf7         dis[i]=INF;
\f1\fs24 \cf0 \
...
\f0\fs22 \cf7         \cf6 if\cf7 (mmap[\cf8 0\cf7 ][i]&&mmap[\cf8 0\cf7 ][i]<dis[i])\{
\f1\fs24 \cf0 \

\f0\fs22 \cf7             dis[i]=mmap[\cf8 0\cf7 ][i];
\f1\fs24 \cf0 \
...
\f0\fs22 \cf7     \cf6 int\cf7  k=\cf8 1\cf7 ,now=\cf8 0\cf7 ,minn;
\f1\fs24 \cf0 \

\f0\fs22 \cf7     \cf6 while\cf7 (k<n)\{
\f1\fs24 \cf0 \

\f0\fs22 \cf7         minn=INF;
\f1\fs24 \cf0 \

\f0\fs22 \cf7         \cf6 for\cf7 (\cf6 int\cf7  j=\cf8 0\cf7 ;j<n;j++)\{
\f1\fs24 \cf0 \

\f0\fs22 \cf7             \cf6 if\cf7 (!vis[j]&&dis[j]<minn)\{
\f1\fs24 \cf0 \

\f0\fs22 \cf7                 minn=dis[j];
\f1\fs24 \cf0 \
...
\f0\fs22 \cf2 //        cout<<(char)(now+'A')<<" "<<dis[now]<<endl;
\f1\fs24 \cf0 \

\f0\fs22 \cf7         vis[now]=\cf8 1\cf7 ;
\f1\fs24 \cf0 \

\f0\fs22 \cf7         ans+=dis[now];
\f1\fs24 \cf0 \
...
\f0\fs22 \cf7             \cf6 if\cf7 (mmap[now][i]&&mmap[now][i]<dis[i])\{
\f1\fs24 \cf0 \

\f0\fs22 \cf7                 dis[i]=mmap[now][i];
\f1\fs24 \cf0 \
